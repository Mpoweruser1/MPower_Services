...
export default function ActivePatientBanner() {
  ...
  return (
    <div style={{ background: 'rgba(90,154,223,0.08)', border: '1px solid rgba(90,154,223,0.2)', borderRadius: 10, padding: '10px 14px', marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <div>
        <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.35)', letterSpacing: 1 }}>ACTIVE PATIENT · చురుకైన రోగి</p>
      ...
      <button
        ...
        style={{ padding: '6px 12px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 7, background: 'transparent', cursor: 'pointer', fontSize: 11, color: 'rgba(255,255,255,0.4)', fontFamily: 'Inter, sans-serif' }}
      >
        Clear ✕
      </button>
    </div>
