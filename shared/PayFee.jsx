...
export default function PayFee() {
  ...
  if (loading) return (
    <div style={S.page}>
      <div style={S.card}>
        <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.6)', fontSize: 13 }}>Loading payment details...</p>
      </div>
    </div>
  );
  ...
  if (paid) return (
    <div style={S.page}>
      ...
      <div style={{ ...S.card, textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', margin: 0 }}>ఫీజు విజయవంతంగా చెల్లించబడింది · రశీదు WhatsApp కి పంపబడింది</p>
      </div>
    </div>
  );
      ...
      <div style={S.card}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24, paddingBottom: 20, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.6)' }}>Fee payment · ఫీజు చెల్లింపు</p>
          </div>
        </div>

        {/* Student info */}
        <div style={{ background: '#111113', borderRadius: 10, padding: '12px 14px', marginBottom: 20 }}>
          <p style={{ margin: '0 0 3px', fontSize: 12, color: 'rgba(255,255,255,0.6)', letterSpacing: 1 }}>STUDENT · విద్యార్థి</p>
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', letterSpacing: 1, margin: '0 0 8px' }}>AMOUNT DUE · చెల్లించవలసిన మొత్తం</p>
        ...
        <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', textAlign: 'center', marginTop: 12, lineHeight: 1.6 }}>
